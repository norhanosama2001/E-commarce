    ...
    <>
      <div className="footer bg-gray-200 py-8 mt-8 ">
        <div className="container">
          <h2 className="capitalize text-3xl mx-6">Get The FreshCart App</h2>
          <p className="capitalize text-gray-500 my-4 mx-6">
            We Will Send You a link, open it on your phone to download the app
          </p>

          <form
            className="input mx-7 flex items-center justify-between  flex-wrap md:flex-nowrap gap-4 p-4"
          >
            <input
              type="email"
          ...
          <div className="flex my-4 items-center justify-between flex-wrap  border-gray-300 border-y py-6">
            <div className="flex items-center justify-center w-full xl:w-auto gap-2 flex-wrap">
              <h3 className="capitalize text-2xl text-center mx-6">
                payment partners
              </h3>
